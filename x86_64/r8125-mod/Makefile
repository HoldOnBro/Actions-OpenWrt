...
define KernelPackage/r8125-mod
  TITLE:=RTL8125 nic driver for poor performance CPU.
...
define Package/r8125-mod/description
 This package contains a driver for Realtek r8125 chipsets, modified by GanFan.
endef
...
$(eval $(call KernelPackage,r8125-mod))
