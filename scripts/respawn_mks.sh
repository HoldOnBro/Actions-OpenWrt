...
find ./*_plusplus.sh -maxdepth 1 -path "*" | xargs -i sed -i '/^TGT_IMG.*gz$/s/\.img\.gz/\_P\_FOL\.img\.gz/g' {}
...
find ./*_basic.sh -maxdepth 1 -path "*" | xargs -i sed -i '/^TGT_IMG.*gz$/s/\.img\.gz/\_O\_FOL\_SFE\.img\.gz/g' {}
find ./*_plus.sh -maxdepth 1 -path "*" | xargs -i sed -i '/^TGT_IMG.*gz$/s/\.img\.gz/\_P\_FOL\_SFE\.img\.gz/g' {}
